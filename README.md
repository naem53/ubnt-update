...
> Но, если вы не знаете владельца сервера VPN, то будьте остороны, так как при обновлении через сторонние сервисы (сервера VPN), существует вероятность подмены, отдаваемых потребителю пакетов обновления, на модифицированные, с внедрённым вредоносным кодом.
